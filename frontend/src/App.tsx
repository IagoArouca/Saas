...
import { TalentHub } from './pages/TalentDetails'; 
...
export const App = () => {
  ...
  const getRedirectPath = () => {
    ...
    if (user?.role === 'RECRUITER') return "/dashboard/talentos";
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route path="/dashboard/talentos" element={<DashboardLayout><TalentHub /></DashboardLayout>} />
