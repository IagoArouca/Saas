            ...
            <div key={proj.id} className="group relative bg-[#0a0f1a] border border-slate-800 rounded-xl p-1 transition-all duration-300 hover:border-emerald-500/40 hover:shadow-[0_0_30px_rgba(16,185,129,0.05)] flex flex-col">
              ...
              <div className="p-3 pt-0">
                <button 
                  ...
                  className="cursor-pointer w-full py-3 bg-emerald-600/10 hover:bg-emerald-600 text-emerald-500 hover:text-white text-[10px] font-black rounded-lg transition-all flex items-center justify-center gap-2 border border-emerald-500/20 uppercase tracking-[0.2em] group-hover:shadow-[0_0_15px_rgba(16,185,129,0.2)]"
                >
